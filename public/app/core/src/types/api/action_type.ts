enum ActionType {
  ...
  CLOUD_BILLING_LOAD_PRODUCTS = "envkey/api/CLOUD_BILLING_LOAD_PRODUCTS",

  CLOUD_BILLING_CHECK_V1_PENDING_UPGRADE = "envkey/api/CLOUD_BILLING_CHECK_V1_PENDING_UPGRADE",
